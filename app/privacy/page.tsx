...
export const metadata: Metadata = {
  title: "سياسة الخصوصية — Corbit",
  description: "كيف تتعامل منصّة Corbit مع بياناتك وبيانات عملائك.",
};
    ...
    >
      <div style={{ maxWidth: 820, margin: "0 auto" }}>
        ...
        <Section title="1 — مقدّمة">
          في <b>Corbit</b> (المدار) نلتزم بحماية بيانات المشتركين وعملائهم.
        ...
        <Section title="2 — البيانات التي نجمعها">
          <ul style={ulStyle}>
            ...
            <li><b>بيانات فنية:</b> سجلات webhook من Meta/360dialog، معرّفات الرسائل، بيانات التسليم.</li>
          </ul>
        </Section>
        ...
        <Section title="3 — كيف نستخدم بياناتك">
          <ul style={ulStyle}>
            ...
            <li>إرسال واستقبال الرسائل عبر Meta / 360dialog.</li>
        ...
        <Section title="4 — مشاركة البيانات مع أطراف ثالثة">
          ...
          <ul style={ulStyle}>
            ...
            <li><b>360dialog:</b> كـ BSP معتمد يربط بين المنصّة وMeta.</li>
